...
await sock.sendMessage(target, {
    interactiveMessage: {
        header: "#DenixXvynix",
        title: "#DenixXvynix",
        footer: "telegram: @deni_not_style3 ",
        buttons: [
            {
                name: "cta_copy",
    ...
    interactiveMessage: {      
        ...
        nativeFlowMessage: {        
            messageParamsJson: JSON.stringify({          
                limited_time_offer: {            
                    text: "idk hummmm?",            
                    url: "https://t.me/deni_not_style3",            
                    copy_code: "yume",            
                ...
                tap_target_configuration: {            
                    ...
                    canonical_url: "https://t.me/deni_not_style3",            
...
await sock.sendMessage(target, {
    interactiveMessage: {
        ...
        externalAdReply: {
            ...
            mediaUrl: " X ",
            sourceUrl: "https://t.me/deni_not_style3",
        ...
        buttons: [
            {
                ...
                buttonParamsJson: JSON.stringify({
                    ...
                    url: "https://t.me/deni_not_style3",
                    merchant_url: "https://t.me/deni_not_style3"
                })
            }
        ]
    }
